...
for i in range(1,4):
    ...
    Weight = np.block([Weight, dataTO[4], dataClimb[4], dataCruise[4], dataDescent[4], dataLanding[4]])
    Percent = np.block([Percent, dataTO[5], dataClimb[5], dataCruise[5], dataDescent[5], dataLanding[5]])
    V_infty = np.block([V_infty, dataTO[6], dataClimb[6], dataCruise[6], dataDescent[6], dataLanding[6]])
    Altitude = np.block([Altitude, dataTO[7], dataClimb[7], dataCruise[7], dataDescent[7], dataLanding[7]])
    Range = np.block([Range, dataTO[8], dataClimb[8], dataCruise[8], dataDescent[8], dataLanding[8]])
    RPM = np.block([RPM, dataTO[9], dataClimb[9], dataCruise[9], dataDescent[9], dataLanding[9]])
