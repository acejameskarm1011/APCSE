...
dataTO = pd.read_csv(filepath + "Take-Off{}-lap-1.csv".format(missionType), header=None).to_numpy()
dataClimb = pd.read_csv(filepath + "Climb{}-lap-1.csv".format(missionType), header=None).to_numpy()
dataCruise = pd.read_csv(filepath + "Cruise{}-lap-1.csv".format(missionType),  header=None).to_numpy()
dataDescent = pd.read_csv(filepath + "Descent{}-lap-1.csv".format(missionType),  header=None).to_numpy()
dataLanding = pd.read_csv(filepath + "Landing{}-lap-1.csv".format(missionType),  header=None).to_numpy()
