...
# Pitch_Arr = np.linspace(0,20,n)/180*np.pi         # 1000 -> 0.1066374803233
# V_infty = 76*sp.constants.knot
...
Velocity_Arr = np.linspace(30,180,n)*sp.constants.knot     # 1000 -> 0.1066374803233
...
for (h, c) in zip(Altitude_Arr, color):
    ...
    axs[1].plot(RPM_Arr, Thrust_Arr/Drag_Arr, color = c, label = "h = {} ft".format(h))
